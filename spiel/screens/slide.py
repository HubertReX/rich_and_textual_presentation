...
class SlideScreen(SpielScreen):
    BINDINGS = [
        ...
        Binding("up,home", "first_slide", "Go to first slide."),
        # Binding("home", "first_slide", "Go to first slide."),
        Binding("down,end", "last_slide", "Go to last slide."),
        # Binding("end", "last_slide", "Go to last slide."),
